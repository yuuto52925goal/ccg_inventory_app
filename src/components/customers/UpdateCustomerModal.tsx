...
interface UpdateCustomerModalProps {
  ...
  onClose: () => void;
  onSuccess: () => void;
  updateCustomer: (customer: CustomerType) => Promise<void>;
}

export default function UpdateCustomerModal({ customer, onClose, onSuccess, updateCustomer }: UpdateCustomerModalProps) {
